...
import io.vertx.blueprint.microservice.order.OrderVerticle;
...
//    }
        ...
        Vertx.clusteredVertx(new VertxOptions().setHAEnabled(true), vertx ->
                vertx.result().deployVerticle(OrderVerticle.class.getName(), options)
        );
